...
It can be used to list and reverse the latest changes (restore to a specific point-in-time) for an OwnCDN [Storage service](../service-types/storage.md) database.
