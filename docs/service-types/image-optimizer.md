...
See [UI /  Edit Service - Image Optimizer](../ui/edit-service/image-optimizer.md) for configuration options.
...
The [Public HTTP Binding service](public-http-binding.md) has a setting to automatically append this (`webp=1`) to the URL query path if the incoming HTTP request indicates support for WebP. 

Use the "Quality %" setting to control quality of compressed images (both WebP and JPEG) - see [UI /  Edit Service - Image Optimizer](../ui/edit-service/image-optimizer.md).
...
You can also configure a fixed Maximum Width - see [UI /  Edit Service - Image Optimizer](../ui/edit-service/image-optimizer.md).
