---
Slug: ui-about-license
DocID: 42
---
# UI / About / License

This page shows copyright, version, and license information.

## License

Shows the current license status.

### "Request trial license..." button

(only available when not licensed)

Click this button to request a trial license - to test out the software for a limited period before buying a license.
