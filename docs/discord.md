---
Slug: how-to-generate-webhook-url-in-discord
DocID: 44
---
# How to generate webhook URL in Discord

To configure OwnCDN to send alerts via Discord (see [UI / Settings](ui_settings.md)), you will need a Discord webhook URL.
