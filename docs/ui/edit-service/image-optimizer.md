---
id: SvcEditImageOptimizer
---
# UI / Edit Service - Image Optimizer

Use this page in the UI when creating / editing an [Image Optimizer service](../../service-types/image-optimizer.md).
...
> This is because the query parameters will typically be used for image generation. See [Image Optimizer service](../../service-types/image-optimizer.md) for more on this.
