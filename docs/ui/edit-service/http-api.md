...
Use this page in the UI when editing the [HTTP API service](../../service-types/http-api.md). 
...
> [!NOTE]
> The HTTP API service will also process incoming requests for the host name / port number specified for the [HTTP UI](ui.md) service.
